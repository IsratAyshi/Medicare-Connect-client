...
import { FaStar } from 'react-icons/fa6'; // Clean solid star for reviews

export default function SuccesStories() {
    // Dummy data array mimicking exact values from image_900b51.png for easy database swap later
    const reviews = [
        {
            name: "Robert Thompson",
            role: "Cardiac Patient",
            avatar: "/assets/logo.png", // Replace with your avatar filenames later
            rating: 5,
            text: "The care I received at Medicare Connect was exceptional. From booking to post-consultation follow-up, the process was seamless and incredibly professional."
        },
        {
            name: "Sarah Jenkins",
            ...
            rating: 5,
            text: "Finding a specialist for my daughter was so easy. The platform is intuitive and we felt in safe hands immediately with Dr. Baret. Highly recommend!"
        },
        {
            ...
            avatar: "/assets/logo.png",
            rating: 5,
            text: "The 24/7 support is a life-saver. Being able to access my medical records and chat with a professional at any hour gives me immense peace of mind."
        }
    ];
    ...
    return (
        <section className="w-full bg-[#004ca3] dark:bg-[#001731] py-24 px-6 font-manrope relative overflow-hidden transition-colors duration-200">
            ...
            {/* Big Decorative Quote Mark Graphic in the Top Right Background */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {reviews.map((review, index) => (
                        <div
                            key={index}
                            className="
                bg-[#004391] dark:bg-[#002249] 
                border border-[#ffffff]/10 dark:border-white/5 
                rounded-2xl p-8 flex flex-col justify-between
                shadow-[0_10px_30px_rgba(0,0,0,0.1)]
                hover:shadow-[0_20px_40px_rgba(0,0,0,0.2)]
                hover:-translate-y-2 hover:bg-[#003d85] dark:hover:bg-[#002957]
                transition-all duration-300 ease-out
              "
                        >
                            <div>
                                {/* 5 Star Rating Indicator Row */}
                            ...
                            <div className="flex items-center gap-4 border-t border-white/10 pt-5 mt-auto">
                                <div className="w-11 h-11 rounded-full overflow-hidden bg-slate-300 border-2 border-white/20 relative shrink-0">
                                    <Image
                                        src={review.avatar}
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <span className="text-[13px] font-[400] text-[#93c5fd] dark:text-[#7eb6fc]">
                                        {review.role}
                                    </span>
                                </div>
                            </div>
